...
MOTHER_REPO_ROOT = REPO_ROOT.parents[1]
...
if (MOTHER_REPO_ROOT / "studio" / "frontdesk" / "web_hermes").exists():
    sys.path.insert(0, str(MOTHER_REPO_ROOT))
...
try:
    from studio.frontdesk.web_hermes import (  # noqa: E402
