...
class WebLiteTests(unittest.TestCase):
    ...
    def test_web_chat_panel_assets_wire_to_stream_endpoint(self) -> None:
        ...
        self.assertIn("optional Hermes-native chat tool layer", readme)
        self.assertIn("not a standalone public package", readme)
        self.assertIn("not the core Course2Knowledge Lite architecture", readme)
